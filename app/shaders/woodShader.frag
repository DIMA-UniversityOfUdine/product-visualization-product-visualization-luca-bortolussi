...
void main() {
  ...
  vec3 outRadiance = (PI* clight_frontLight * nDotl1 * BRDF1 + ambientLight * cdiff) +
  (PI* clight_fillLight * nDotl2 * BRDF2 + ambientLight * cdiff) +
  (PI* clight_backLight * nDotl3 * BRDF3 + ambientLight * cdiff);
